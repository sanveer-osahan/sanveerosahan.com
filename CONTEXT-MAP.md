...
- [`docs/databricks/DATA-MODEL.md`](./docs/databricks/DATA-MODEL.md): the synthetic support ticket dataset and the generator behind it. The Article it was built for is gone; the dataset is kept because it is expensive to recreate.
