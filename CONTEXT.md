...
Each Post carries its own context for terms and decisions local to that Post. This file holds only site-wide vocabulary. See `CONTEXT-MAP.md` for the index.
