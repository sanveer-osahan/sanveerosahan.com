...
pages: 224
cover: "../../assets/books/zero-to-one.jpg"
readDate: 2026-08-11
amazonCom: "https://www.amazon.com/Zero-One-Notes-Startups-Future/dp/0804139296"
amazonIn: "https://www.amazon.in/Zero-One-Start-Build-Future/dp/0753555190"
---
...
<svg viewBox="0 0 640 380" role="img" aria-labelledby="progress-axes-title" style="font-family: var(--font-sans)">
<title id="progress-axes-title">Two axes of progress: globalization runs horizontally from 1 to N, new technology runs vertically from 0 to 1.</title>
<defs>
<marker id="progress-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
<path d="M 0 0 L 10 5 L 0 10 z" fill="currentColor" />
</marker>
</defs>
<line x1="210" y1="320" x2="210" y2="40" stroke="currentColor" stroke-width="1.5" marker-end="url(#progress-arrow)" />
<line x1="210" y1="320" x2="612" y2="320" stroke="currentColor" stroke-width="1.5" marker-end="url(#progress-arrow)" />
<text x="194" y="158" text-anchor="end" font-size="15" fill="currentColor">New technology</text>
<text x="194" y="180" text-anchor="end" font-size="15" fill="currentColor">(vertical progress - 0 -> 1)</text>
<text x="230" y="68" font-size="14" fill="currentColor" opacity="0.72">Build something new</text>
<text x="600" y="298" text-anchor="end" font-size="14" fill="currentColor" opacity="0.72">Scale what already works</text>
<text x="411" y="358" text-anchor="middle" font-size="15" fill="currentColor">Globalization (horizontal progress - 1 → N)</text>
</svg>
<figcaption>The two axes of progress.</figcaption>
</figure>
